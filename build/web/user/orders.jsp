<%-- 
    Document   : orders
    Created on : Aug 10, 2023, 1:05:08 PM
    Author     : Kavindu
--%>
                 ...
                 while(rs.next())
        {
            %>                                         <div class ="userexdata">
					...
					<ul>
						...
						<li><a href="orders.jsp" class="active">My Orders <span>></span></a></li>
...
try{
    ...
    ResultSet rs1=st.executeQuery("select * from mycart inner join product where mycart.product_id=product.id and mycart.email='"+email+"' and mycart.orderDate is not NULL");
    while(rs1.next()){
        sno=sno+1;
